...
export function listGroup(groupName, pageNum = 1, pageSize = 10) {
  ...
  return request({
    url: '/system/admin/sysGroup/list',
    method: 'get',
    params: data
  })
}
...
export function addGroup(groupName, groupDesc) {
  ...
  return request({
    url: '/system/admin/sysGroup/save',
    method: 'post',
...
export function getGroupById(id) {
  return request({
    url: '/system/admin/sysGroup/getById',
    method: 'get',
    params: id
  })
}
...
export function updateGroup(id, groupName, groupDesc) {
  ...
  return request({
    url: '/system/admin/sysGroup/update',
    method: 'post',
    data: qs.stringify(data)
  })
}
...
export function removeGroup(ids) {
  const data = { ids }
  return request({
    url: '/system/admin/sysGroup/removeByIds',
    method: 'post',
    data: qs.stringify(data)
  })
}
